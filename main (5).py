"""
Inplement a function called sort_students that takes a list of student objects as iuput and sorts the
...
def sort_students(student_list):
  # sort the list of students in descenaing order of CGPA
